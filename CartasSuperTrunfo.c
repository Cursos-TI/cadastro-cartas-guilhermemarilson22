...
char estado[20]; // Uma letra de A a H
char cod_cart[50]; // A letra do estado seguida de um número de 01 a 04
char cidade[50]; // Nome de uma cidade 
...
int pont_tu; //A quantidade de pontos turísticos na cidade
